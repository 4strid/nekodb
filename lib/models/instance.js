			...
			if (Array.isArray(target)) {
				if (prop === '$push') {
					return function (push) {
						...
						target._$push = target._$push || []
						target._$push.push(push)
					}
				}
				if (prop === '$pop') {
					return function (direction) {
						target._$pop = direction
					}
				}
				if (prop === '$addToSet') {
					return function (add) {
						...
						target._$addToSet = target._$addToSet || []
						target._$addToSet.push(add)
					}
				}
				if (prop === '$pull') {
					return function (filter) {
						target._$pull = filter
					}
				}
				if (arrayModifyingMethods.includes(prop)) {
					target._replaceArray = true
					return target[prop]
				}
			}
			return target[prop]
			...
			Object.defineProperty(o, field, {
				...
				set (value) {
					if (Array.isArray(value)) {
						...
						this._updates[field]._replaceArray = true
						return
					}
